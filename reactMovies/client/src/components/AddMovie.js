            ...
            errorMessage = <div className="error">Car Details are incorrect<br/></div>;
                           ...
                           let genresErrorMessage = ""
                            ...
                            if(!this.validateTitle())
                                    {
                                        titleErrorMessage = <div className="error">Title must be a string<br/></div>
                                    }
            ...
            <div className="form-add-container">
                ...
                <Form>
                    ...
                    <Form.Group controlId="plot">
                                            ...
                                            <Form.Control ref = {(input) => { this.inputToFocus = input }} type="text" name="plot" value={this.state.plot} onChange={this.handleChange} />

                                        </Form.Group>

                    <Form.Group controlId="actors">
                                            <Form.Label>Actors</Form.Label>
                                            <Form.Control ref = {(input) => { this.inputToFocus = input }} type="text" name="actors" value={this.state.actors} onChange={this.handleChange} />
                   ...
                   {genresErrorMessage}
                    ...
                    <LinkInClass value="Add" className="add-form-add-button" onClick={this.handleSubmit}/>

                    <Link className="add-form-button" to={"/DisplayAllMovies"}>Cancel</Link>
